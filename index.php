...
<body>
    ...
    <div class ="container">
        ...
        <p>Enter your detalis and submit this form to confirm your participation in the trip</p>
        <?php
        if($insert == true){
        echo "<p class='submitMsg' >Thanks for submiting your form. We are happy to see you joining for the Manali trip.</p>";
        }
        ?>
